...
import br.org.serratec.trabalho.repository.AssociadoRepository;
...
//		associadoBanco.setCategoria(associado.getCategoria());
//		associadoBanco.setTitulo(associado.getTitulo());
//		associadoBanco.setDataPublicacao(associado.getDataPublicacao());
//		associadoBanco.setIsbn(associado.getIsbn());
